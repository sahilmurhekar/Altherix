...
const AppointmentsPage = () => {
  const { startCall, currentCall, endCall } = useVideoCall();
            ...
            return (
              ...
              >
                ...
                <div className="pt-4 border-t border-zinc-700 flex justify-between items-center">
                  ...
                  {/* Quick Video Call Button for Online Upcoming Appointments */}
                  {!isPast && (appointment.status === 'confirmed' || appointment.status === 'pending') && appointment.consultationMode === 'online' && (
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        startCall(appointment._id);
